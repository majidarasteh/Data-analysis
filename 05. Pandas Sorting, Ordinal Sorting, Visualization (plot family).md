...
<img width="420" height="350" alt="image" src="https://github.com/user-attachments/assets/5df19508-acd9-4a14-8417-d5bf1accdbaf" />
...
| --------------- | -------------------------------- | ------------------------------------- |
| Sorting         | `sort_values()`                  | Sort rows by a column                 |
| Ordinal Sorting | `Categorical(..., ordered=True)` | Sort custom-ordered categories        |
| Line Chart      | `plot.line`                      | Trend visualization                   |
| Bar Chart       | `plot.bar`                       | Vertical bars                         |
| Horizontal Bar  | `plot.barh`                      | Horizontal bars                       |
| Histogram       | `hist()`                         | Show data distribution                |
| Box Plot        | `box()`                          | Spread & outliers                     |
| Area Chart      | `area()`                         | Filled curve plot                     |
| Scatter Plot    | `scatter()`                      | Relationship between two numeric vars |
| Pie Chart       | `pie()`                          | Category proportions                  |
| Hexbin          | `hexbin()`                       | Density plot                          |
| Stacked Bar     | `bar(stacked=True)`              | Composition inside bars               |
