...
## **6.1.2 Extracting Date Parts (`dt.year`, `dt.month`, `dt.day`)**
...
# **6.2 Encoding (Handling Categorical Data)**
...
## **6.2.2 One-Hot Encoding (`get_dummies`)**
...
## **6.2.3 Convert to Categorical Type**
...
## **6.3.2 IQR Method (Common Methods to Detect Outliers)**
...
### Example of removing outliers by Pandas IQR method
